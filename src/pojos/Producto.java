...
public class Producto {
    ...
    public Producto(String idProducto, String nomProducto, String descProducto, double stockProducto, File fotoProducto, String unidadProducto, double precioCompraProducto, double precioVentaProdcuto, double existenciasProducto, int idCategoria, int idProveedor) {
